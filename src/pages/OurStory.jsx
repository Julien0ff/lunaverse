  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          padding: '2rem',
          background: hovered ? 'rgba(15, 26, 82, 0.5)' : 'rgba(10, 19, 64, 0.3)',
          border: `1px solid ${hovered ? 'rgba(120,140,255,0.2)' : 'rgba(120,140,255,0.05)'}`,
      ...
      >
        ...
        <div style={{
          ...
          width: '100%',
          height: '100%',
          background: `radial-gradient(circle at ${isEven ? '100%' : '0%'} 0%, ${event.color}15 0%, transparent 60%)`,
